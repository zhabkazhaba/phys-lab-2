    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        if (ImGui::BeginTabBar("##tabs1", ImGuiTabBarFlags_None)) {
            ...
            if (ImGui::BeginTabItem("Other")) {
                ...
                ImGui::Text("Average x: %.4f", measureList1.getAvX());
                ImGui::SeparatorText("Y");
                ImGui::Text("Average y: %.4f", measureList1.getAvY());
                ImGui::SeparatorText("Deviation x");
                ImGui::Text("Average dev_x: %.4f m", measureList1.getAvDevX());
                ImGui::EndTabItem();
            }
        ...
        if (ImGui::BeginTabBar("##tabs2", ImGuiTabBarFlags_None)) {
            if (ImGui::BeginTabItem("Task 1")) {
                ...
                ImGui::Text("Y: %.3f ", measureList1.getAvY());
                ImGui::SeparatorText("Error values");
                ImGui::Text("Absolute error: %.3f", measureList1.getYErr());
                ImGui::Text("Relative error: %.2f %%", measureList1.getYErr() * 100 / measureList1.getAvY());
                ImGui::SeparatorText("Total value");
                ImGui::TextColored(t_colors[SUCCESS], "Y = %.3f +- %.3f kg*mm^2", measureList1.getAvY(), measureList1.getYErr());
